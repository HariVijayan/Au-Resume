...
const CustomDiv = ({ resumeData, setResumeData, templateType }) => {
  ...
  return (
    ...
    <div id="dv-CustomDivButtons" className="NavigationButtons">
            ...
            <button type="submit" onClick={() => handleSubmit()} className="RightNavigationButtons">Submit <svg xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 -960 960 960" width="24px" fill="#e3e3e3"><path d="M382-240 154-468l57-57 171 171 367-367 57 57-424 424Z"/></svg></button>
          </div>
          </div>
