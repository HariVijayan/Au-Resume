...
const Ug = ({ templateType }) => {
  ...
  const addNewUg = (e) => {
    e.preventDefault();
    const updatedUg = [...resumeDataNew.education.underGraduate];
    updatedUg.push({
      name: "",
      university: "",
      year: "",
    ...
    <div id="dv-MainFormAndPreview">
      <div id="dv-MainForm">
        ...
        <div id="dv-EducationUgWrapper" className="WrapperClass">
          ...
          {resumeDataNew.education.underGraduate.map(
              ...
              >
                ...
                >
                  <input
                    ...
                    onChange={(e) => {
                      let updatedUg = [
                        ...resumeDataNew.education.underGraduate,
                      ];
                ...
                >
                  ...
                  <svg
                    onClick={() => showOrHideInfoDiv(`Ug Period${newUgIndex}`)}
                    xmlns="http://www.w3.org/2000/svg"
                    className="MandatoryInputSvg"
                    height="24px"
                    viewBox="0 -960 960 960"
