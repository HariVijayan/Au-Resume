          ...
          {resumeData.education[0].ug_degree.map((ug_degree, index) => (
            <div key={index} id="dv-EducationUg" className="SubWrapper">
              <div id="dv-EducationUgName" className="InputWrapper">
                <input
                  type="text"
                  id="in-rb_edu_ug_name"
                  name="ug_degree_name"
                  value={ug_degree.ug_degree_name}
                  onChange={(e) => handleEducationInputChange(e, index)}
                  placeholder=" "
                />
                <label htmlFor="in-rb_edu_ug_name" className="TextFieldLabel">
                  Name
                </label>
              </div>
              <div id="dv-EducationUgUniversity" className="InputWrapper">
                <input
                  ...
                  placeholder=" "
                />
                <label htmlFor="in-rb_edu_ug_uni" className="TextFieldLabel">
                  University
                </label>
              </div>
              <div id="dv-EducationUgYear" className="InputWrapper">
                <input
                  type="text"
                  id="in-rb_edu_ug_year"
                  name="ug_degree_year"
                  value={ug_degree.ug_degree_year}
                  onChange={(e) => handleEducationInputChange(e, index)}
                  placeholder=" "
                />
                <label htmlFor="in-rb_edu_ug_year" className="TextFieldLabel">
                  Year
                </label>
              </div>
              <div id="dv-EducationUgCgpa" className="InputWrapper">
                <input
                  type="text"
                  id="in-rb_edu_ug_cgpa"
                  name="ug_degree_cgpa"
                  value={ug_degree.ug_degree_cgpa}
                  onChange={(e) => handleEducationInputChange(e, index)}
                  placeholder=" "
                />
                <label htmlFor="in-rb_edu_ug_cgpa" className="TextFieldLabel">
                  CGPA
                </label>
              </div>
              <div id="dv-EducationUgAdditionalInfo" className="InputWrapper">
                <input
                  type="text"
                  id="in-rb_edu_ug_addl"
                  name="ug_additional_info"
                  value={ug_degree.ug_additional_info}
                  onChange={(e) => handleEducationInputChange(e, index)}
                  placeholder=" "
                />
                <label htmlFor="in-rb_edu_ug_addl" className="TextFieldLabel">
                  Additional Info
                </label>
              </div>
            </div>
