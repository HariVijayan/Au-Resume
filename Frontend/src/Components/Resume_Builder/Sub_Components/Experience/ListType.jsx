      ...
      {resumeData.experience.map(
        (newExperienceEntry, newExperienceIndex) =>
          newExperienceEntry.style === "ListType" && (
            ...
            >
              <div
                id={`dv-ELCompanyNameCopy${newExperienceIndex + 1}`}
                className="InputWrapper"
              >
                <input
                  type="text"
                  id={`in-rb_el_exp_name_copy${newExperienceIndex + 1}`}
                  name="company"
                ...
                />
                <label
                  htmlFor={`in-rb_el_exp_name_copy${newExperienceIndex + 1}`}
                ...
                <svg
                  onClick={() =>
                    showOrHideInfoDiv(`Company Name${newExperienceIndex + 1}`)
                  }
              ...
              {infoDiv === `Company Name${newExperienceIndex + 1}` && (
                <InfoDiv
              ...
              <div
                id={`dv-ELLocationCopy${newExperienceIndex + 1}`}
                className="InputWrapper"
              >
                <input
                  type="text"
                  id={`in-rb_el_exp_location_copy${newExperienceIndex + 1}`}
                  name="location"
                ...
                />
                <label
                  htmlFor={`in-rb_el_exp_location_copy${
                ...
                <svg
                  onClick={() =>
                    showOrHideInfoDiv(`Work Location${newExperienceIndex + 1}`)
                  }
                  xmlns="http://www.w3.org/2000/svg"
              ...
              {infoDiv === `Work Location${newExperienceIndex + 1}` && (
                <InfoDiv
              ...
              <div
                id={`dv-ELPeriodCopy${newExperienceIndex + 1}`}
                className="InputWrapper"
              >
                <input
                  type="text"
                  id={`in-rb_el_exp_year_copy${newExperienceIndex + 1}`}
                  name="year"
                ...
                <svg
                  onClick={() =>
                    showOrHideInfoDiv(`Work Period${newExperienceIndex + 1}`)
                  }
                  xmlns="http://www.w3.org/2000/svg"
                  className="MandatoryInputSvg"
                  height="24px"
              ...
              {infoDiv === `Work Period${newExperienceIndex + 1}` && (
                <InfoDiv
                  requirement={"Mandatory"}
              ...
              <div
                id={`dv-ELDesignationCopy${newExperienceIndex + 1}`}
                className="InputWrapper"
              >
                <input
                  type="text"
                  id={`in-rb_el_exp_desg_copy${newExperienceIndex + 1}`}
                  name="designation"
                ...
                <svg
                  onClick={() =>
                    showOrHideInfoDiv(`Designation${newExperienceIndex + 1}`)
                  }
                  xmlns="http://www.w3.org/2000/svg"
                  className="MandatoryInputSvg"
                  height="24px"
              ...
              {infoDiv === `Designation${newExperienceIndex + 1}` && (
                <InfoDiv
                  requirement={"Mandatory"}
                  explanation={
              ...
              <div
                id={`dv-ELTeamNameCopy${newExperienceIndex + 1}`}
                className="InputWrapper"
              >
                <input
                  type="text"
                  id={`in-rb_el_exp_team_copy${newExperienceIndex + 1}`}
                  name="team"
                ...
                />
                <label
                  htmlFor={`in-rb_el_exp_team_copy${newExperienceIndex + 1}`}
                  className="TextFieldLabel"
                >
                  Team Name
                </label>
                <svg
                  onClick={() =>
                    showOrHideInfoDiv(`Team Name${newExperienceIndex + 1}`)
                  }
                  xmlns="http://www.w3.org/2000/svg"
              ...
              {infoDiv === `Team Name${newExperienceIndex + 1}` && (
                <InfoDiv
              ...
              <div
                id={`dv-ELRolesCopy${newExperienceIndex + 1}`}
                className="InputWrapper"
              >
                <input
                  type="text"
                  name="roles"
                  id={`in-rb_el_exp_roles_copy${newExperienceIndex + 1}`}
                  value={newExperienceEntry.roles}
                  onChange={(e) => modifyExperienceInput(e, newExperienceIndex)}
                  placeholder=" "
                />
                <label
                  htmlFor={`in-rb_el_exp_roles_copy${newExperienceIndex + 1}`}
                  className="TextFieldLabel"
                >
                  Roles
                </label>
                <svg
                  onClick={() =>
                    showOrHideInfoDiv(`Roles${newExperienceIndex + 1}`)
                  }
                  xmlns="http://www.w3.org/2000/svg"
                  className="MandatoryInputSvg"
                  height="24px"
              ...
              {infoDiv === `Roles${newExperienceIndex + 1}` && (
                <InfoDiv
                  requirement={"Mandatory"}
                  explanation={
