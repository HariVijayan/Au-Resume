...
function RouteWrapper() {
  ...
  const routesWithSidebar = ['/resume-builder/template-choosing', '/resume-builder/bio-summary', '/resume-builder/experience', '/resume-builder/education/phd', '/resume-builder/education/pg', '/resume-builder/education/ug', '/resume-builder/education/diploma', '/resume-builder/education/school', '/resume-builder/projects', '/resume-builder/skills', '/resume-builder/certifications', '/resume-builder/languages-known', '/resume-builder/custom-input', '/success-score/jd', '/success-score/role'];

  useEffect(() => {
    const sidebarState = () => {
      const element = document.querySelector('.Sidebar');
      if (element) {
        if (routesWithSidebar.includes(location.pathname)) {
